...
- 4 "punti energia": az standard, puoi evocare 1d4+1 operativi ladri fatti d'ombra (sono considerati come il phantom dello spiritista, quindi esterni, ma completamente fisici, fatti di ectoplasma) di lvl pari a metà lvl utilizzatore (arrotondato per difetto), l'evocazione dura un'ora per livello utilizzatore.