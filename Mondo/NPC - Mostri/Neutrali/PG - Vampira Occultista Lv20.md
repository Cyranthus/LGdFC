...
### Movimento
**Velocità** 30 ft.; scalata ragnesca (Str) a volontà; forma gassosa a volontà (Sop, volo 20 ft. perfetta, indefinita); *Mente Batte Gravità* (potere focus, volo 60 ft. perfetta, 1 focus); *Stivali della Velocità*, come *rapidità* 10 round/giorno (+30 ft. velocità, +1 CA, +1 Riflessi, +1 attacco solo mentre attiva)
...
|---|---|---|---|---|---|
| 16 (+3) | 18 (+4) | — | 27 (+8) | 14 (+2) | 18 (+4) |

**Con equipaggiamento completo** (Cintura del Vigore Fisico +6 Str/Des, Diadema del Vigore Mentale +6 Int/Car):

| Str | Des | Cos | Int | Sag | Car |
|---|---|---|---|---|---|
| 22 (+6) | 24 (+7) | — | 33 (+11) | 14 (+2) | 24 (+7) |

*Tutti i numeri della scheda (CA, TS, attacchi, abilità, CD, focus mentale) qui sotto usano già i valori "con equipaggiamento".*

**Abilità** *(20 gradi assunti nelle abilità elencate, +3 bonus di classe — l'Occultista le ha tutte come abilità di classe — più mod. caratteristica con equipaggiamento, bonus razziali vampireschi dove indicato)*

Raggirare +38 (+8 razziale), Diplomazia +30, Rendersi Irriconoscibile +30, Volare +30, Conoscenze (arcane) +34, Conoscenze (storia) +34, Conoscenze (piani) +34, Conoscenze (religione) +34, Linguistica +34, Percezione +35 (+8 razziale, +2 Attento), Intuizione +35 (+8 razziale, +2 Attento), Rune Magiche +34, Furtività +38 (+8 razziale), Usare Oggetti Magici +43 (+3 Focalizzazione sulle Abilità, +10 Abilità Magica sugli Oggetti)
...
| 4 (5°) | Volontà di Ferro | +2 TS Volontà |
| 5 (7°) | Focalizzazione sugli Incantesimi Superiore (Necromanzia) | +1 CD addizionale (tot. +2) |
| 6 (9°) | Focalizzazione sulle Abilità (Usare Oggetti Magici) | +3 UOM |
| 7 (11°) | Incantesimo Persistente | metamagia: TS bersaglio tira due volte, tiene il peggiore |
| 8 (13°) | **Legame Forte con l'Implemento** (scelto: Ammaliamento) | entro 30 ft. dalla Collana nessuna prova di concentrazione per lanciare incantesimi di Ammaliamento; oltre, CD 15+liv. invece di 20+liv. |
| 9 (15°) | **Spostamento Rapido del Focus** | 1/giorno può spostare focus tra implementi come azione completa (round intero) invece di 1 minuto |
| 10 (17°) | **Spostamento Efficiente del Focus** | 2/giorno, quando sposta focus tra implementi non perde il punto "-1" (trasferimento 1:1) |
...
- **Focus Mentale**: 31 base (liv. 20 + mod. Int +11 *con Diadema*) + 2 (Focus Mentale Extra) = **33 punti generici**, + **4 punti** vincolati alla scuola Padroneggiata (Ammaliamento). **Totale 37**.
- **Implementi (Scuole)**: 7 su 8 — **Abiurazione, Divinazione, Ammaliamento, Evocazione, Negromanzia, Trasmutazione, Invocazione**. *Omessa: Illusione* (cambio rispetto alla versione precedente, su tua richiesta).
- **Padronanza dell'Implemento (20°)**: scuola **Ammaliamento**. CD poteri focus di Ammaliamento +4, livello trattato come 24° per quei poteri, +4 focus vincolato, durezza implementi Ammaliamento +20.

**CD dei Tiri Salvezza** *(con Int 33/+11 da equipaggiamento)*
- Poteri Focus (generico): 10 + 10 (metà liv.) + 11 (Int) = **31**
- Poteri Focus di Ammaliamento (Padronanza): **35**
...
|---|---|---|
| **Abiurazione** | Bracciali | *Bracciali del Boia* — di un giustiziere convinto fino all'ultimo di proteggere gli innocenti. |
| **Divinazione** | Lenti | *Occhiali del Veggente Cieco* — di un profeta che vide la propria morte senza poterla fermare. |
| **Ammaliamento** | Collana | *Collana dell'Amore Perduto* — ora scuola **Padroneggiata**; dono di un promesso sposo mai tornato dalla guerra. |
| **Evocazione** | Bastone (rod) | *Bastone Spezzato di un Inquisitore* — spezzato nel momento in cui capì di aver bruciato l'innocente sbagliata. |
| **Negromanzia** | Teschio | *Teschio del Primo Amante* — il primo uomo che ha dissanguato, conservato come reliquia e monito. |
| **Trasmutazione** | Arma (pugnale) | *Pugnale del Patto di Sangue* — la lama con cui ha firmato il patto che l'ha resa ciò che è ora. |
| **Invocazione** | Specchio | *Specchio del Passaggio* — non riflette lei (per la sua natura vampirica), ma si dice mostri porte verso altrove a chi sa chiederglielo. |
...
| 9 | Interdizione di Energia | Evocazione | 1 focus | 7° |
...
## Corredo da Personaggio Giocante (~880.000 mo, Tabella Ricchezza per Livello, 20° liv.)

I sette catalizzatori sono ora anche veri oggetti magici, oltre a mantenere il loro potere di risonanza.
...
**Verifica del totale**: 26.100+50.000+40.000+50.000+90.000+90.000+25.000+12.000+2.500+75.500+50.302+175.000+10.000+183.600 = **880.002 mo**, praticamente identico agli 880.000 mo previsti dalla Tabella Ricchezza per Livello — rientra nel budget con un margine di 2 mo (irrilevante, arrotondabile).

**Nota sui Bracciali (catalizzatore Abiurazione)**: li ho lasciati volutamente senza incantesimo/potenziamento — sono solo masterwork, nessun costo aggiuntivo significativo. È una scelta, non una svista: puoi benissimo spendere lì una parte della riserva "Varie" (es. dei *Bracers of Armor* non sarebbero comunque utili, dato che già indossa un'armatura vera che dà più CA).

---

## Note per il Tavolo

- Le due eccezioni di regolamento segnalate in cima vanno confermate col master prima di scendere in campo.
- Essendo ora un PG, ricordati che le **debolezze vampiriche** (specchi, simboli sacri, aglio, acqua corrente, luce solare) restano meccanicamente in vigore e vanno giocate: sono spesso la parte più interessante di un PG non-morto.
- *Conduttore Occulto* + *Spostamento Efficiente del Focus* creano una sinergia forte: puoi "salvare" focus nel tuo corpo come riserva d'emergenza e spostarlo poi senza perdite verso Ammaliamento (scuola Padroneggiata) in combattimento.
