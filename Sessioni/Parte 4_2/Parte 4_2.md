...
- [[#Korvosa - Criptata|Korvosa - Criptata]]
...
- Semipiano di Varkhan (1 Nodo), colore verde
...
- Bestie magiche casuali
  - 1x Bolla CR 14 : https://aonprd.com/MonsterDisplay.aspx?ItemName=Bolla
  ![[bolla.jpg]]
- 4x Veldenar CR 10:  https://aonprd.com/MonsterDisplay.aspx?ItemName=Veldenar
  ![[Veldenar.png]]
...
- Timeless: spell non immediati perdurano finchè non interrotti, non si prova più fame, sete o stanchezza, anche se questi effetti si accumulano e si subiscono tutti in una volta una volta che ci si sposta in un piano dove il tempo scorre normalmente.
- Fire: ogni round, si subiscono 3d10 danni da fuoco; incantesimi come planar adaption, resist fire o elemental immunity possono far ignorare questo danno.


Campo di battaglia tempestato da un vento infuocato.
resti di mezzi meccanizzati, e creature bestiali sono sparsi ovunque.
...
Souston è un piccolo villaggio di pescatori (300 abitanti circa) andoreniano affacciato sul Mare Interno, situato a circa 240 miglia esattamente a est della capitale, Almas. L’abitato è composto da piccole baracche dai colori vivaci, addossate alla costa dolcemente digradante.
...
- Gli eroi noteranno che c'è una discreta tensione in città; in pochi li guarderanno, e quasi tutti non li saluteranno.
  Raccogliere Informazioni (CD 20): Gli abitanti sono stati recentemente minacciati dal temibile pirata [[Capitano Durgan -Catena Rossa- Kreed - CR 10]]: Il temibile pirata ha ordinato alla cittadina di trovare e consegnargli entro l'alba il tesoro del Capitano Souston, altrimenti il villaggio verrà raso al suolo e gli abitanti verranno fatti tutti prigionieri.

- Due gruppi di Cercatori (tutto Terrestri Giocanti CR 9) sono stati mandati in aiuto al villaggio, passeranno la notte alla taverna (un paio di loro farà delle ronde di guardia per la città e per il porto) - Tutti hanno il chip di controllo.
  - Se interagiranno con gli Eroi, gli chiederanno che ci fanno qui, se sono lì per completare la quest, se si se hanno già trovato il tesoro o se hanno qualche indizio... o e se nel caso vogliono aiutarli.
  - uno dei due gruppi, è parecchio frustrato dal fatto di non aver trovato il tesoro e che, tra l'altro, è la seconda volta che prova a fare questa quest...

## La Notte

Nella notte, I due gruppi di cercatori, cominciano ad uccidere tutti gli abitanti, al fine di trovare, in modo sbrigativo, il tesoro del pirata Souston, o almeno qualche indizio.
Perception 25: sentite un urlo lontano, provenire da fuori...
...
Dopo circa una decina di case con dentro


## L'Alba

attacco dei pirati (tutti i pirati hanno dei chip di bg)
